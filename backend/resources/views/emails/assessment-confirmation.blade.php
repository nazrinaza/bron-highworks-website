...
<tr><td style="background:#cbdd29;padding:24px 32px;color:#080a0b"><img src="{{ $message->embed(public_path('brand/assets/bron-logo.png')) }}" width="220" alt="BRON Highworks" style="display:block;width:220px;max-width:100%;height:auto;border:0"><span style="display:block;margin-top:12px;font-size:12px;font-weight:bold;letter-spacing:2px">HIGH ACCESS. SERIOUS CLEANING.</span></td></tr>
