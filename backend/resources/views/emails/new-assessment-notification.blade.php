...
<tr><td style="background:#cbdd29;padding:24px 32px"><img src="{{ $message->embed(public_path('brand/assets/bron-logo.png')) }}" width="220" alt="BRON Highworks" style="display:block;width:220px;max-width:100%;height:auto;border:0"></td></tr>
